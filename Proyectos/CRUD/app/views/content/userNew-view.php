<div class="containeris-fluid mb-6">
    <h1 class="title">Usuarios</h1>
    <h2 class="subtitle">Nuevo Usuario</h2>
</div>

<div class="container pd-6 pt-6">
    <form action="<?=APP_URL;?>app/ajax/usuarioAjax.php" class="FormularioAjax" method="POST" autocomplete="off" enctype="multipart/form-data">
        ...
        <div class="columns">
            <div class="column">
                <div class="control">
                    <label>Usuario</label>
                    <input type="text" class="input" name="usuario_usuario" pattern="[a-zA-Z0-9]{4,40}" maxlength="20" required>
                </div>
            </div>
            <div class="column">
                <div class="control">
            ...
            <div class="column">
                <div class="file has-name is-boxed">
                    <label class="file-label">
                        <input type="file" class="file-input" name="usuario_foto" accept=".jpg, .png, .jpeg">
                        <span class="file-cta">
