	...
	<div class="columns">
		<div class="column is-two-fifths">
			...
			<figure class="image mb-6">
                <img class="is-rounded" src="<?= APP_URL ?>app/views/fotos/<?= $datos['usuario_foto'] ?>">
			</figure>
            ...
            <?php else: ?>    
			<figure class="image mb-6">
			  	<img class="is-rounded" src="<?= APP_URL ?>app/views/fotos/usuario.jpg">
			</figure>
            <?php endif ?>        
		</div>
		...
		<div class="column">
			<form class="mb-6 has-text-centered FormularioAjax" action="<?=APP_URL; ?>app/ajax/usuarioAjax.php"
