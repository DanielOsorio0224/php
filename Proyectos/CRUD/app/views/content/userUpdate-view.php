...
<div class="container pb-6 pt-6">
	...
	<h2 class="title has-text-centered"><?= $datos['usuario_nombre']." ".$datos['usuario_apellido']; ?></h2>

	<p class="has-text-centered pb-6"><?= "<strong>Usuario creado:</strong> "
    .date("d-m-Y h:i:s A",strtotime($datos['usuario_creado']))."
     &nbsp; <strong>Usuario actualizado:</strong>"
     .date("d-m-Y h:i:s A",strtotime($datos['usuario_actualizado'])); ?></p>
	...
	<form class="FormularioAjax" action="<?=APP_URL; ?>app/ajax/usuarioAjax.php" method="POST" autocomplete="off" >
		...
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Nombres</label>
				  	<input class="input" type="text" name="usuario_nombre" value="<?=$datos['usuario_nombre']; ?>"
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Apellidos</label>
				  	<input class="input" type="text" name="usuario_apellido" value="<?=$datos['usuario_apellido']; ?>"
                     pattern="[a-zA-ZáéíóúÁÉÍÓÚñÑ ]{3,40}" maxlength="40" required >
				</div>
		  	</div>
		</div>
		<div class="columns">
		  	<div class="column">
		    	<div class="control">
					<label>Usuario</label>
				  	<input class="input" type="text" name="usuario_usuario" value="<?=$datos['usuario_usuario']; ?>"
		  	...
		  	<div class="column">
		    	<div class="control">
					<label>Email</label>
				  	<input class="input" type="email" name="usuario_email" value="<?=$datos['usuario_email']; ?>"
                     maxlength="70" >
				</div>
		  	</div>
		</div>
