...
class Producto{
    ...
    public function getAllCategory(){
        $sql = "SELECT p.* , c.nombre AS 'catnombre' FROM productos p INNER JOIN categorias c ON c.id = p.categoriaId WHERE p.categoriaId = {$this->getCategoriaId()} ORDER BY id DESC;";
